...
import { AToken__factory, AaveProtocolDataProvider__factory, IERC20__factory, ILendingPool, ILendingPoolAddressesProvider__factory } from '../typechain-types';
